...
public class DataBase {
	 ...
	 */
	protected void NewTrainer(String imie, String nazwisko , String PESEL, Date data_urodzenia) throws SQLException {
		Scanner input = new Scanner(System.in);
		...
		Statement statement = null;
		   ...
		   String selectTableSQL = "INSERT INTO TRENERZY (ID_TRENERA, IMIE, NAZWISKO, PESEL, DATA_URODZENIA) "
				   + "VALUES (TRENERZY_ID_SEQ.NEXTVAL, '" + imie + "', '" + nazwisko + "', " + PESEL + ", '" + data_urodzenia + "')";
