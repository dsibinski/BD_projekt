...
public class WindowTrainer extends JFrame {
	...
	public WindowTrainer(DataBase _dataBase, String[] row) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				WindowTrainer.class.getResource("/Resources/logo.png")));
		dataBase = _dataBase;
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "1942",
		...
		btnDodaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				// ////// porównanie peselu z dat¹ urodzenia

				Boolean pes = Validate.peselDate(PESEL, year, month, day);
				...
				if (pes == true) {
					try {
						...
						if (!filled)
							dataBase.NewTrainer(imie, nazwisko, PESEL,
									data_urodzenia, adres, nr_telefonu, email);
						else
							dataBase.updateTrainers(imie, nazwisko, PESEL,
									data_urodzenia, adres, nr_telefonu, email,
									PESEL_old);
					...
					JOptionPane.showMessageDialog(new JFrame(),
							"Pesel nie zgadza sie z podana data urodzenia");
				}
